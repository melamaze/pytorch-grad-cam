    ...
    for folder in folder_name:
        ...
        for image_path in glob.glob(folder):
            ...
            for it in range(times):
                ...
                pixel_value = SPI(heatmap = heatmap, dataset = "MNIST")
                pixel_value2 = SPI(heatmap = heatmap2, dataset = "MNIST")
                pixel_value3 = SPI(heatmap = heatmap3, dataset = "MNIST")
                ...
                rgb_img = FEM(image = rgb_img, dataset = "MNIST", pixel_value = pixel_value, pixel_num = 12)
                rgb_img2 = FEM(image = rgb_img2, dataset = "MNIST", pixel_value = pixel_value2, pixel_num = 16)
                rgb_img3 = FEM(image = rgb_img3, dataset = "MNIST", pixel_value = pixel_value3, pixel_num = 20)  
